...
(function ($) {
    ...
    $.fn.percentageLoader = function (params) {
        ...
        lingrad.addColorStop(0, '#41879e');
        lingrad.addColorStop(1, '#2b667a');

        /* Create inner gradient for the outer ring */
        innerGrad = ctx.createLinearGradient(cX, cX * 0.133333, cX, canvas.height - cX * 0.133333);
        innerGrad.addColorStop(0, '#f2f2e9');
        innerGrad.addColorStop(1, '#f2f2e9');
        ...
        tubeGrad.addColorStop(1, '#f2f2e9');
        ...
        * than true / false */
        ...
        drawLoader = function () {
            ...
            (function () {
                ...
                percentageText.style.color = '#2b667a';
